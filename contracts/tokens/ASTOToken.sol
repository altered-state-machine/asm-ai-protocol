...
contract ASTOToken is ERC20Burnable, ReentrancyGuard {
     ...
     */
    constructor(address agent, address finance) ERC20("Altered State Machine Utility Token", "ASTO") {
        aragonAgent = agent;
    ...
    function mint(uint256 amount) public nonReentrant {
        ...
        IAragonFinance(aragonFinance).deposit(address(this), amount, "Initialising $ASTO supply");
    }
}
