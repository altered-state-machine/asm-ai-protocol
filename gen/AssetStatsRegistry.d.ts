...
interface AssetStatsRegistryInterface extends ethers.utils.Interface {
  functions: {
...
export class AssetStatsRegistry extends BaseContract {
  ...
  interface: AssetStatsRegistryInterface;
