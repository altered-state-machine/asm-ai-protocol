...
interface MemoryTreeEnumerableInterface extends ethers.utils.Interface {
  functions: {
...
export class MemoryTreeEnumerable extends BaseContract {
  ...
  functions: {
    ...
    memoryNodesOfMemoryTree(
      ...
      [
        ...
        treeNodes: ([BigNumber, BigNumber[], string] & {
          memoryTreeId: BigNumber;
          children: BigNumber[];
          storageURI: string;
        })[];
