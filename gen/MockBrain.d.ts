...
interface MockBrainInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "faucetTo", values: [string]): string;
  encodeFunctionData(
...
export class MockBrain extends BaseContract {
  ...
  cidv0Hashes(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
  ...
  callStatic: {
    ...
    faucetTo(to: string, overrides?: CallOverrides): Promise<void>;
